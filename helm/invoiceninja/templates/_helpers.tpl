...
{{- else }}
{{- .Values.redisConnection.port | default 6379 }}
{{- end }}
{{- end }}
...
{{- else }}
{{- .Values.redisConnection.database | default 0 }}
{{- end }}
{{- end }}
...
{{- if .Values.redis.enabled }}
{{- .Values.redis.cacheDatabase | default 1 }}
{{- else }}
{{- .Values.redisConnection.cacheDatabase | default 1 }}
{{- end }}
{{- end }}
