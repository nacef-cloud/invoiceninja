...
$lang = array(
    ...
    'pro_plan_feature8' => 'Possibilité de joindre des PDF aux e-mails des clients',
    'resume' => 'Reprendre',
    ...
    'enterprise_plan_features' => 'Le plan Entreprise ajoute la prise en charge de plusieurs utilisateurs et de pièces jointes, :link pour voir la liste complète des fonctionnalités.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'invoices_are_attached' => 'Vos factures PDF sont jointes.',
    ...
    'expense_mailbox_taken' => 'La boîte aux lettres entrante est déjà utilisée',
    'expense_mailbox_invalid' => 'La boîte aux lettres entrante ne correspond pas au schéma requis',
    ...
    'upgrade_to_upload_images' => 'Passez au plan Entreprise pour télécharger des fichiers et des images',
    ...
    'enable_client_upload_help' => 'Autoriser les clients à télécharger des documents/pièces jointes',
    ...
    'enable_stamp_duty' => 'Activer le Timbre Fiscal',
    'stamp_duty_amount' => 'Montant du Timbre Fiscal',
    'stamp_duty_threshold' => 'Seuil du Timbre Fiscal',
    'stamp_duty_help' => 'Appliquer un droit de timbre fixe lorsque le total de la facture dépasse le seuil',
    ...
    'client_statement_body' => 'Votre relevé du :start _date au :end _date est joint.',
    ...
    'nordigen_handler_error_heading_unknown' => 'Une erreur s&#39;est produite',
    ...
    'paypal_advanced_cards' => 'Paiements par carte avancés',
    'local_domain_help' => 'Domaine EHLO (facultatif)',
    'port_help' => 'soit 25 587 465',
    'host_help' => 'c&#39;est-à-dire smtp.gmail.com',
    'always_show_required_fields' => 'Toujours afficher les champs obligatoires du formulaire',
    'always_show_required_fields_help' => 'Affiche toujours les champs obligatoires du formulaire lors du paiement',
    'advanced_cards' => 'Cartes avancées',
    'activity_140' => 'Déclaration envoyée à :client',
    'invoice_net_amount' => 'Montant net de la facture',
    'round_to_minutes' => 'Arrondir à la minute',
    '1_second' => '1 seconde',
    '1_minute' => '1 minute',
    '5_minutes' => '5 minutes',
    ...
    'task_round_to_nearest_help' => 'L&#39;intervalle auquel arrondir la tâche.',
    ...
    'btcpay_refund_body' => 'Un remboursement vous a été accordé. Pour le réclamer via BTCPay, veuillez cliquer sur ce lien :',
    'currency_mauritanian_ouguiya' => 'Ouguiya mauritanien',
    'currency_bhutan_ngultrum' => 'Ngultrum du Bhoutan',
    'end_of_month' => 'Fin du mois',
    'merge_e_invoice_to_pdf' => 'Fusionner la facture électronique et le PDF',
    'task_assigned_subject' => 'Nouvelle affectation de tâche [Tâche :task ] [ :date ]',
    'task_assigned_body' => 'La tâche :task vous a été attribuée<br><br> Description : :description<br><br> Client : :client',
    'activity_141' => 'L&#39;utilisateur :user a saisi la note : :notes',
    'quote_reminder_subject' => 'Rappel : Citation :quote de :company',
    'quote_reminder_message' => 'Rappel pour le devis :number pour :amount',
    'quote_reminder1' => 'Rappel de la première citation',
    'before_valid_until_date' => 'Avant la date de validité',
    'after_valid_until_date' => 'Après la date de validité',
    ...
    'edocument_import_already_exists' => 'La facture a déjà été importée sur :date',
    ...
    'task_assigned_notification_help' => 'Envoyer un e-mail lorsqu&#39;une tâche est attribuée',
    'invoices_locked_end_of_month' => 'Les factures sont bloquées à la fin du mois',
    ...
    'one_page_checkout_help' => 'Activer le nouveau flux de paiement sur une seule page',
    ...
    'expense_mailbox' => 'Adresse e-mail entrante',
    'expense_mailbox_help' => 'L&#39;adresse e-mail entrante qui accepte les documents de dépenses. c&#39;est-à-dire. expenses@invoiceninja.com',
    'expense_mailbox_active' => 'Boîte aux lettres des dépenses',
    'expense_mailbox_active_help' => 'Permet le traitement de documents tels que des reçus pour les notes de frais',
    'inbound_mailbox_allow_company_users' => 'Autoriser les expéditeurs de l&#39;entreprise',
    'inbound_mailbox_allow_company_users_help' => 'Permet aux utilisateurs de l&#39;entreprise d&#39;envoyer des documents de dépenses.',
    'inbound_mailbox_allow_vendors' => 'Autoriser les expéditeurs de fournisseurs',
    'inbound_mailbox_allow_vendors_help' => 'Permet aux fournisseurs de l&#39;entreprise d&#39;envoyer des documents de dépenses',
    'inbound_mailbox_allow_clients' => 'Autoriser les expéditeurs clients',
    'inbound_mailbox_allow_clients_help' => 'Permet aux clients d&#39;envoyer des documents de dépenses',
    'inbound_mailbox_whitelist' => 'Liste autorisée des expéditeurs entrants',
    'inbound_mailbox_whitelist_help' => 'Liste séparée par des virgules des e-mails qui devraient être autorisés à envoyer des e-mails pour traitement',
    'inbound_mailbox_blacklist' => 'Liste des expéditeurs entrants bannis',
    'inbound_mailbox_blacklist_help' => 'Liste séparée par des virgules des e-mails qui ne sont pas autorisés à envoyer des e-mails pour traitement',
    'inbound_mailbox_allow_unknown' => 'Autoriser tous les expéditeurs',
    'inbound_mailbox_allow_unknown_help' => 'Autoriser n&#39;importe qui à envoyer un e-mail de dépenses pour traitement',
    'quick_actions' => 'Actions rapides',
    'end_all_sessions_help' => 'Déconnecte tous les utilisateurs et demande à tous les utilisateurs actifs de se réauthentifier.',
    'updated_records' => 'Enregistrements mis à jour',
    'vat_not_registered' => 'Vendeur non enregistré à la TVA',
    'small_company_info' => 'Aucune divulgation de la taxe de vente conformément au § 19 UStG',
    'peppol_onboarding' => 'Il semble que ce soit la première fois que vous utilisez PEPPOL.',
    'get_started' => 'Commencer',
    'configure_peppol' => 'Configurer PEPPOL',
    'step' => 'Étape',
    'peppol_whitelabel_warning' => 'Une licence en marque blanche est requise pour utiliser la facturation électronique sur le réseau PEPPOL.',
    ...
    'peppol_disconnect_short' => 'Déconnectez-vous de PEPPOL.',
    ...
    'log_duration_words' => 'Durée du journal de temps en mots',
    'log_duration' => 'Durée du journal de bord',
    ...
    'search_placeholder' => 'Trouvez des factures, des clients et plus encore',
    'invalid_vat_number' => "Le numéro de TVA n&#39;est pas valide pour le pays sélectionné. Le format doit être le code du pays suivi d&#39;un numéro uniquement, par exemple DE123456789",
    'acts_as_sender' => 'Envoyer des factures électroniques',
    'acts_as_receiver' => 'Recevoir des factures électroniques',
    'peppol_token_generated' => 'Le jeton PEPPOL a été généré avec succès.',
    'peppol_token_description' => 'Le jeton est utilisé comme une autre étape pour garantir que les factures sont envoyées en toute sécurité. Contrairement aux licences en marque blanche, le jeton peut être renouvelé à tout moment sans avoir à attendre le support d&#39;Invoice Ninja.',
    'peppol_token_warning' => 'Vous devez générer un jeton pour continuer.',
    'generate_token' => 'Générer un jeton',
    'total_credits_amount' => 'Nombre de crédits',
    'sales_above_threshold' => 'Ventes supérieures au seuil',
    'changing_vat_and_id_number_note' => 'Vous ne pouvez pas modifier votre numéro de TVA ou votre numéro d&#39;identification une fois PEPPOL configuré.',
    'iban_help' => 'Le numéro IBAN complet',
    'bic_swift' => 'Code BIC/Swift',
    'bic_swift_help' => 'L&#39;identifiant bancaire',
    ...
    'card_type_help' => 'c&#39;est-à-dire VISA, AMEX',
    'card_number_help' => '4 derniers chiffres seulement',
    'card_holder' => 'Nom du titulaire de la carte',
    'tokenize' => 'Tokeniser',
    'tokenize_help' => 'Tokeniser le mode de paiement pour une utilisation future.',
    'credit_card_stripe_help' => 'Acceptez les paiements par carte de crédit via Stripe.',
    'bank_transfer_stripe_help' => 'Prélèvement automatique ACH. Paiements en USD, vérification instantanée disponible.',
    'alipay_stripe_help' => 'Alipay permet aux utilisateurs en Chine de payer en toute sécurité en utilisant leurs portefeuilles mobiles.',
    ...
    'sepa_stripe_help' => 'Prélèvement SEPA (Espace unique de paiements en euros).',
    'bancontact_stripe_help' => 'Bancontact est un moyen de paiement très utilisé en Belgique.',
    ...
    'klarna_stripe_help' => 'Klarna achetez maintenant et payez plus tard en plusieurs fois ou selon un calendrier défini.',
    'bacs_stripe_help' => 'Prélèvement automatique BACS pour les comptes bancaires britanniques, couramment utilisé pour la facturation des abonnements.',
    ...
    'add_license_to_env' => 'Nous aurons besoin de votre clé de licence pour les communications futures avec nos services. Assurez-vous d&#39;utiliser LICENSE_KEY comme variable d&#39;environnement.',
    'white_label_license_not_present' => 'Licence non trouvée. Assurez-vous de définir LICENSE_KEY comme variable d&#39;environnement.',
    'white_label_license_not_found' => 'Licence de marque blanche non trouvée.',
    'details_update_info' => 'Nous mettrons à jour les détails de votre entreprise avec les informations fournies.',
    'sales_above_threshold' => 'Ventes supérieures au seuil',
    ...
    'peppol_cleared_for_sending' => 'Autorisé par l&#39;administration fiscale, envoi au destinataire',
